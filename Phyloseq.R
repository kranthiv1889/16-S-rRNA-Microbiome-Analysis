library("phyloseq")
library("ggplot2")
biom=("stability.trim.contigs.good.unique.good.filter.unique.pick.an.unique_list.unique.biom")
phyloseq=import_biom(biom)
phyloseq
png("16_S_Rank2.png", width = 1000, height =1200,res=75)
plot_bar(phyloseq, fill="Rank2")
dev.off()
png("16_S_Rank5.png", width = 1000, height =1500,res=75)
...
phyloseq_tree
sampledata=read.csv("sampledata", header=TRUE, sep="")
sampledata
...
phyloseq_final
png("16_S_Rank5_Extraction.png", width = 1000, height =1500,res=75)
plot_bar(phyloseq_final, x="Extraction_Method", fill="Rank5")
dev.off()
png("16_S_Rank5_facetgrid1.png",width = 1000, height =1500,res=75)
...
png("16_S_psmelt_Rank2.png",width = 1000, height =1200,res=75)
...
dev.off()
png("16_S_psmelt_Rank2_nofill.png",width = 1000, height =1200,res=75)
